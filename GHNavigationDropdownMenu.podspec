#
#  Be sure to run `pod spec lint GHNavigationDropdownMenu.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                  The elegant dropdown menu, written in Swift, appears underneath navigation bar to display a list of related items when a user click on the navigation title. Forked from PhamBaTho/BTNavigationDropdownMenu
                   DESC
